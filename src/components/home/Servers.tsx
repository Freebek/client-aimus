...
const Servers = async () => {
  ...
  //   {
  //     img: "/assets/server1.webp",
  //     title: "RETAKES #1",
  //     name: "de_mirage",
  //     users: 12,
  //   },
  //   {
  //     img: "/assets/de_inferno.webp",
  //     title: "RETAKES #2",
  //     name: "de_inferno",
  //     users: 8,
  //   },
  ...
  const response = await fetch("https://panel.aimus.uz/api/servers");
    ...
    <section className="w-full mb-[100px] my-[30px]">
      <Container style="text-center">
        <div className="w-full text-left mb-[20px]">
          <h2 className="text-white text-xl mb-[20px]">Наши Серверы</h2>
          <FilterServers />
        ...
        <div className="flex flex-wrap gap-[15px]">
          <div className="relative overflow-hidden flex-1 bg-backgr px-[25px] py-[20px] rounded-[25px]">
            <div className="text-left w-full">
              <p className="text-white opacity-50 font-medium text-lg">
                Админы
              </p>
              <p className="text-[24px] text-primary">28</p>
            </div>
            <svg
          ...
          <div className="relative overflow-hidden flex-1 bg-backgr px-[25px] py-[20px] rounded-[25px]">
            <div className="text-left w-full">
              <p className="text-white opacity-50 font-medium text-lg">Баны</p>
              <p className="text-[24px] text-primary">14015</p>
            </div>
            <svg
              className="absolute top-[5px] right-[-35px] rotate-[15deg] w-[100px] h-[100px] opacity-30 dark:text-white"
              aria-hidden="true"
          ...
          <div className="relative overflow-hidden flex-1 bg-backgr px-[25px] py-[20px] rounded-[25px]">
            <div className="text-left w-full">
              <p className="text-white opacity-50 font-medium text-lg">Муты</p>
              <p className="text-[24px] text-primary">3876</p>
            </div>
            <svg
              className="absolute top-[5px] right-[-35px] rotate-[15deg] w-[100px] h-[100px] opacity-30 dark:text-white"
              aria-hidden="true"
          ...
          <div className="relative overflow-hidden flex-1 bg-backgr px-[25px] py-[20px] rounded-[25px]">
            <div className="text-left w-full">
              <p className="text-white opacity-50 font-medium text-lg">Гаги</p>
              <p className="text-[24px] text-primary">930</p>
            </div>
            <svg
              className="absolute top-[5px] right-[-35px] rotate-[15deg] w-[100px] h-[100px] opacity-30 dark:text-white"
              aria-hidden="true"
